Public Class SubtractionForm
    Dim matrice() As String = {"2x2 Matrix", "3x3 Matrix"}
    Private Sub SubtractionForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub calculateButton_Click(sender As Object, e As EventArgs) Handles calculateButton.Click
        ...
        C00lb.Text = A(0, 0) - B(0, 0)
        C01lb.Text = A(0, 1) - B(0, 1)
        C10lb.Text = A(1, 0) - A(1, 0)
        C11lb.Text = A(1, 1) - B(1, 1)
    End Sub
    ...
    Private Sub calButton_Click(sender As Object, e As EventArgs) Handles calButton.Click
        ...
        cc00.Text = A3(0, 0) - B3(0, 0)
        cc01.Text = A3(0, 1) - B3(0, 1)
        cc02.Text = A3(0, 2) - B3(0, 2)
        cc10.Text = A3(1, 0) - B3(1, 0)
        cc11.Text = A3(1, 1) - B3(1, 1)
        cc12.Text = A3(1, 2) - B3(1, 2)
        cc20.Text = A3(2, 0) - B3(2, 0)
        cc21.Text = A3(2, 1) - B3(2, 1)
        cc22.Text = A3(2, 2) - B3(2, 2)
    End Sub
